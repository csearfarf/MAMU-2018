...
<body class="landing-page sidebar-collapse" style="background-color:#ffffff;">
  ...
  <div class="main">
      <div class="container  pb-2">
        <div class="col-lg-5 m-auto text-center pt-2">
          <h4 class="description text-primary mt-0 mb-0" style="font-size:1.5rem;">Mister & Miss University of Makati</h4>
          <h3 class="description text-primary mt-0 mb-2" style="font-size:1.5rem;">People's Choice Ranking </h3>
        </div>
       </div>
       ...
       <div class="container-fluid pt-0 mt-0">
            <div class="container">
                ...
                <div class="row" id="loadITNAPLEASE">
                  <!--GET CANDIDATES :P-->
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 m-auto pt-2">
         <div class="row">
           <div class="container">
             ...
             <section class="customer-logos slider pb-1" style="background-color: transparent; min-height: 50px;">
...
$("#loadITNAPLEASE").load('./backend/loadRank.php')
}, 5000);
});
</script>
