          ...
          <h3 class="description text-primary mt-0" style="font-size:1.4rem;">CANDIDATES</h3>
            <a href="candidatejudging.php">
                ...
                <a href="candidatejudging2.php">
                  <button class="btn btn-primary " type="submit">Swim Wear Voting</button>
                </a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <div class="tab-pane active gallery" id="mister">
           ...
           <h4 class="text-primary  text-center mb-3 mt-0">SWIM WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">BEAUTY AND COMPLEXION</h5>
              ...
              <h5 class="text-primary mb-0">BODY FIGURE, MASCULINITY</h5>
...
       $(element).css('opacity', 0);
       ...
       $.ajax({
              url: "backend/castVote2.php", // Url to which the request is send
...
function rate(num){
 ...
 if (num!="" || num!=null) {
       $.ajax({
              url: "backend/loadCandidates2.php", // Url to which the request is send
              type: "POST",             // Type of request to be send, called as method
