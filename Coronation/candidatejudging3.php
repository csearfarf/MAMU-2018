...
<body class="landing-page sidebar-collapse" style="background-color:#ffffff;">
        ...
        <div class="col-12 text-center pt-5">
          ...
          <h3 class="description text-primary mt-0" style="font-size:1.4rem;">CANDIDATES</h3>
             <a href="candidatejudging.php">
                  <button class="btn btn-default " type="submit">Theme Wear Voting</button>
                </a>
                <a href="candidatejudging2.php">
                  <button class="btn btn-default " type="submit">Swim Wear Voting</button>
                </a>
                 <a href="candidatejudging3.php">
                  <button class="btn btn-primary" type="submit">Formal Wear Voting</button>
                </a>
                 <a href="candidatejudging4.php">
                  <button class="btn btn-default" type="submit">Q and A Voting</button>
                </a>
                 <a href="candidatejudging5.php">
                  <button class="btn btn-default " type="submit">Beauty of Face Voting</button>
                </a>
        </div>
       </div>
       <!--Candidates Button-->
      ...
      <div class="modal-content">
              ...
              <div class="col-lg-5 col-sm-12">
                <div class="card bg-dark text-white">
                  ...
                  <div class="card-img-overlay text-center" style="padding-top:99%;">
                    <h4 class="card-title mb-0" id="candidateName1">Hexter Vince Drillon</h4>
                    <h4 class="card-title mb-0" id="candidateID1" hidden="">ID</h4>
                    <p class="card-text" id="candidateCollege1">College of Computer Science</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-7 col-sm-12 pt-5 animated fadeIn" style="margin-top:0px">
           <h4 class="text-primary  text-center mb-3 mt-0">FORMAL WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">BEAUTY AND ELEGANCE</h5>
              <P class="description mt-0" style="font-size:.7em;">This score will be 15 points of Candidate's score</P>
                <div class="row">
                  <div class="col-6" style="border-right: solid grey;">
                    <h3 class="text-center"><span id="lblMenTalents">0</span> points</h3>
                  </div>
                  <div class="col-6">
                  <h3 class="text-center">10 Points</h3>
                  </div>
                </div>
                <div id="menTalents" class="slider"></div>
              <p class="description text-center" style="font-size:.7em;">Tips: Drag slider to the desired number of score (min is 1 point and max is 10 points)</p>
              
              <h5 class="text-primary mb-0">BODY FIGURE AND MASCULINITY</h5>
                <P class="description" style="font-size:.7em;">This score will be 10 points of Candidate's score</P>
                <div class="row">
                  <div class="col-6" style="border-right: solid grey;">
                    <h3 class="text-center"><span id="lblMenPerformance">0</span> points</h3>
                  </div>
                  <div class="col-6">
                    <h3 class="text-center">5 Points</h3>
                  </div>
                </div>
                <div id="menPerformance" class="slider"></div>
              <p class="description text-center" style="font-size:.7em;">Tips: Drag slider to the desired number of score (min is 1 point and max is 5 points)</p>
       ...
       <div class="tab-pane gallery" id="miss">
            ...
            <div class="col-lg-7 col-sm-12 pt-5 animated fadeIn" style="margin-top:0px">
                <h4 class="text-primary  text-center mb-3 mt-0">FORMAL WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">BEAUTY AND ELEGANCE</h5>
              <P class="description mt-0" style="font-size:.7em;">This score will be 10 points of Candidate's score</P>
              <div class="row">
                <div class="col-6" style="border-right: solid grey;">
                  <h3 class="text-center"><span id="lblLadiesTalents">0</span> points</h3>
                </div>
                <div class="col-6">
                  <h3 class="text-center">10 Points</h3>
                </div>
              ...
              <h5 class="text-primary mb-0">BODY FIGURE AND MASCULINITY</h5>
              <P class="description" style="font-size:.7em;">This score will be 5 points of Candidate's score</P>
              <div class="row">
                <div class="col-6" style="border-right: solid grey;">
                  <h3 class="text-center"><span id="lblLadiesPerformance">0</span> points</h3>
                </div>
                <div class="col-6">
                  <h3 class="text-center">5 Points</h3>
                </div>
  ...
  var malepoint1 = document.getElementById('lblMenTalents').innerText//
  var malepoint2 = document.getElementById('lblMenPerformance').innerText//
  ...
  var femalepoint1 = document.getElementById('lblLadiesTalents').innerText//
  var femalepoint2 = document.getElementById('lblLadiesPerformance').innerText//
  

  var computeTotalScoreMale=(malepoint1*1) + (malepoint2*1);//
  var computeTotalScoreFemale=(femalepoint1*1) +(femalepoint2*1);//
...
       $(element).css('opacity', 0);
       ...
       $.ajax({
              url: "backend/castVote3.php", // Url to which the request is send
              type: "POST",             // Type of request to be send, called as method
              data: {idmale:idmale,idfemale:idfemale,malepoint1:malepoint1,malepoint2:malepoint2,computeTotalScoreMale:computeTotalScoreMale,femalepoint1:femalepoint1,femalepoint2:femalepoint2,computeTotalScoreFemale:computeTotalScoreFemale}, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
              dataType: 'json',
...
function rate(num){
 ...
 if (num!="" || num!=null) {
       $.ajax({
              url: "backend/loadCandidates3.php", // Url to which the request is send
              type: "POST",             // Type of request to be send, called as method
