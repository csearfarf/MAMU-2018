        ...
        <div class="col-12 text-center pt-5">
          ...
          <h3 class="description text-primary mt-0" style="font-size:1.4rem;">CANDIDATES</h3>
             <a href="candidatejudging.php">
                  <button class="btn btn-primary " type="submit">Theme Wear Voting</button>
                </a>
        ...
        <div class="modal-body pt-0">
          ...
          <div class="tab-pane active gallery" id="mister">
           ...
           <h4 class="text-primary  text-center mb-3 mt-0">THEME WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">STAGE PRESENCE, POISE AND BEARING</h5>
              ...
              <h5 class="text-primary mb-0">RELEVANCE OF THE COSTUME</h5>
