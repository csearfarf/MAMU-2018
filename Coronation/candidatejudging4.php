          ...
          <a href="candidatejudging.php">
                ...
                <a href="candidatejudging2.php">
                 ...
                 <a href="candidatejudging4.php">
                  <button class="btn btn-primary" type="submit">Q and A Voting</button>
                </a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <div class="tab-pane active gallery" id="mister">
           ...
           <h4 class="text-primary  text-center mb-3 mt-0">Q AND A </h4>
                <h5 class="text-primary mb-0 mt-0">SUBSTANCE OF ANSWER</h5>
              ...
              <h5 class="text-primary mb-0">MANNER OF DELIVERY</h5>
...
       $(element).css('opacity', 0);
       ...
       $.ajax({
              url: "backend/castVote4.php", // Url to which the request is send
...
function rate(num){
 ...
 if (num!="" || num!=null) {
       $.ajax({
              url: "backend/loadCandidates4.php", // Url to which the request is send
              type: "POST",             // Type of request to be send, called as method
