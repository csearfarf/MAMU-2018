            ...
            <a href="candidatejudging.php">
                ...
                <a href="candidatejudging2.php">
                 ...
                 <a href="candidatejudging3.php">
                  <button class="btn btn-default" type="submit">Formal Wear Voting</button>
                </a>
                 <a href="candidatejudging4.php">
                  <button class="btn btn-default" type="submit">Q and A Voting</button>
                </a>
                 <a href="candidatejudging5.php">
                  <button class="btn btn-primary " type="submit">Beauty of Face Voting</button>
                </a>
        </div>
       </div>
       <!--Candidates Button-->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <div class="tab-pane active gallery" id="mister">
           ...
           <h4 class="text-primary  text-center mb-3 mt-0">THEME WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">BEAUTY OF FACE</h5>
              ...
              <h5 class="text-primary mb-0">POISE, BEARING NAD PERSONALITY</h5>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <h3 class="text-center">15 Points</h3>
                  </div>
                </div>
                <div id="menPerformance" class="slider"></div>
              <p class="description text-center" style="font-size:.7em;">Tips: Drag slider to the desired number of score (min is 1 point and max is 15 points)</p>
       ...
       <div class="tab-pane gallery" id="miss">
            ...
            <div class="col-lg-7 col-sm-12 pt-5 animated fadeIn" style="margin-top:0px">
                <h4 class="text-primary  text-center mb-3 mt-0">THEME WEAR</h4>
                <h5 class="text-primary mb-0 mt-0">BEAUTY OF FACE</h5>
              <P class="description mt-0" style="font-size:.7em;">This score will be 25 points of Candidate's score</P>
              <div class="row">
                <div class="col-6" style="border-right: solid grey;">
              ...
              <h5 class="text-primary mb-0">POISE, BEARING NAD PERSONALITY</h5>
              <P class="description" style="font-size:.7em;">This score will be 15 points of Candidate's score</P>
              <div class="row">
                <div class="col-6" style="border-right: solid grey;">
...
       $(element).css('opacity', 0);
       ...
       $.ajax({
              url: "backend/castVote5.php", // Url to which the request is send
...
function rate(num){
 ...
 if (num!="" || num!=null) {
       $.ajax({
              url: "backend/loadCandidates5.php", // Url to which the request is send
              type: "POST",             // Type of request to be send, called as method
