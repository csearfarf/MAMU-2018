...
//male
$query1="INSERT INTO `tbl_votescoro` ( `category_id`, `candidate_id`, `judge_id`, `totalScore`, `score1`, `score2`) VALUES ( '2', '$maleID', '$judgeID', '$computeMale', '$male1', '$male2');";
//female
$query2="INSERT INTO `tbl_votescoro` ( `category_id`, `candidate_id`, `judge_id`, `totalScore`, `score1`, `score2`) VALUES ( '2', '$femaleID', '$judgeID', '$computeFemale', '$female1', '$female2');";
