...
$check="SELECT * FROM `tbl_votescoro` a left join tbl_candidates b on a.candidate_id=b.id where a.judge_id=$judgeID and b.candidate_number=$id and a.category_id=4";
