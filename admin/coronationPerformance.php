...
<body>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Talent/Skills & Performance Details</h3>
            </div>

              <div class="card-body">
              <table class="table text-center table-hover display responsive nowrap" id="talentsSelect">
             <thead>
             <tr>
              <th class="" style="font-weight: bolder;font-size: small;">Judge Name</th>
              <th style="font-weight: bolder;font-size: small;">Computed Score</th>
              <th style="font-weight: bolder;font-size: small;">Talent/Performance Score (50%)</th>
              <th style="font-weight: bolder;font-size: small;">Poise Score (50%)</th>
             </tr>
             </thead>
             <tbody>
             </tbody>
  ...
  var table = jQuery('#talentsSelect').dataTable({
     responsive: true,
    ...
    buttons: [
      ...
      "dom": '<"container"<"row clearfix p-3"<"col-md-4"l><"col-md-4 btn-group"><"col-md-4"f>>><"container"<"row clearfix p-3"<"col-md-12 btn-group"B>>><"container"<"row clearfix p-3"<"col-md-12"rt>>><"container"<"row"<"col-md-3"><"col-md-6"p><"col-md-3">>><"container"<"row p-3"<"col-md-12 btn-group"i>>>',
       "bProcessing": true,
       "sAjaxSource": "./backend/talents/loadSelected.php",
        "bPaginate":true,
