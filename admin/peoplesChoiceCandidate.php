        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">People's Choice Details</h3>
            </div>
             ...
             <thead>
             <tr>
              <th class="" style="font-weight: bolder;font-size: small;">STUDENT NUMBER</th>
              <th style="font-weight: bolder;font-size: small;">STUDENT NAME</th>
              <th style="font-weight: bolder;font-size: small;">COLLEGE</th>
             </tr>
             </thead>
             <tbody>
             </tbody>
  ...
  var table = jQuery('#talentsSelect').dataTable({
    ...
    buttons: [
      ...
      "dom": '<"container"<"row clearfix p-3"<"col-md-4"l><"col-md-4 btn-group"><"col-md-4"f>>><"container"<"row clearfix p-3"<"col-md-12 btn-group"B>>><"container"<"row clearfix p-3"<"col-md-12"rt>>><"container"<"row"<"col-md-3"><"col-md-6"p><"col-md-3">>><"container"<"row p-3"<"col-md-12 btn-group"i>>>',
       "bProcessing": true,
       "sAjaxSource": "./backend/peoples/loadSelected.php",
        "bPaginate":true,
