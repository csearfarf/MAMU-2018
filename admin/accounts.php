...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">List of Accounts</a>
        <!-- Form -->
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            ...
            <div class="card-body">
              <p class=" text-right">
              <button class="btn btn-default btn-md" data-toggle="modal" data-target="#createAccount">Add</button></p>
              <table class="table text-center table-hover display responsive nowrap" id="accounts">
             <thead>
             <tr>
              <th>Name</th>
              <th>Username</th>
                    ...
                    <div class="card bg-secondary shadow border-0 bg-white">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form" method="POST" style="padding: 30px;" id="formCreate">
                                ...
                                <small style="font-size: 19px;">Account Details</small>
                            </div>
                                ...
                                <div class="form-group mb-3">
                                   <h4 class="text-muted">Username</h4>
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control text-center" placeholder="Username" type="text" id="username" autocomplete="off" required>
                                    </div>
                                </div>
                              <div class="form-group mb-3">
                                   <h4 class="text-muted"> Password</h4>
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control text-center" placeholder="Password" type="text" id="password" autocomplete="off" required="">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                  <h4 class="text-muted"> Account Type</h4>
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="ni ni-user-83"></i></span>
                                        </div>
                                         <select name="yesno" id="type" class="form-control text-center" style="
                                            margin-right: 20px;">
                    ...
                    <div class="card bg-secondary shadow border-0 bg-white">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form" method="POST" style="padding: 30px;" id="formEdit">
                                <div class="text-center mb-3">
                                <small style="font-size: 19px;">Edit Account Details</small>
                                ...
                                <div class="form-group mb-3">
                                   <h4 class="text-muted">Username</h4>
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control text-center" placeholder="Username" type="text" id="eusername" autocomplete="off" required>
                                    </div>
                                </div>
                              <div class="form-group mb-3">
                                   <h4 class="text-muted"> Password</h4>
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control text-center" placeholder="Password" type="text" id="epassword" autocomplete="off" required="">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                  <h4 class="text-muted"> Account Type</h4>
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                         ...
                                         <select name="yesno" id="etype" class="form-control text-center" style="
                                            margin-right: 20px;">
                                          <option value="0">Admin</option>
                                          <option value="1">Judge</option>
                                          </select>
...
<script type="text/javascript" src="./backend/scripts/accountsJS.js"></script>
